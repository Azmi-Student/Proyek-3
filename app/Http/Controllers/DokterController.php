    ...
    public function updateHasilCheckup(Request $request, $id)
{
    $request->validate([
        ...
        'gambar_checkup.*' => 'image|mimes:jpeg,png,jpg,gif,svg|max:12048',
    ]);
    ...
    public function destroy($id)
{
    ...
    if (!$reservasi) {
        return redirect()->back()->with('status', 'Reservasi tidak ditemukan!');
    }

    $reservasi->delete();

    return redirect()->back()->with('status', 'Reservasi berhasil dihapus!');
}
